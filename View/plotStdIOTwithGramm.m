...
g(1,1)=gramm('x',sdftm,'y',forGramm.SDF_trials,'color',forGramm.trlLabel,...
    'subset',...
    ((strcmp(forGramm.trlLabel, 'monocular_PO_DE') | strcmp(forGramm.trlLabel, 'IOT_PO_DE')) & ...
...
h(1,1)=gramm('x',sdftm,'y',forGramm.SDF_trials,'color',forGramm.trlLabel,...
    'subset',...
        strcmp(forGramm.trlLabel, 'monocular_PO_DE') |...
        strcmp(forGramm.trlLabel, 'IOT_PO_DE'));
...
FolderName = strcat(OUTDIR_PLOT,'figsFrom-plotStdIOTwithGramm\');   % Your destination folder
cd(FolderName)
